...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird 101')
    game_image['numbers'] = (
    ...
    game_image['message'] = pygame.image.load('images/New Project.png').convert_alpha()
    ...
    game_audio_sound['hit'] = pygame.mixer.Sound('sounds/yeet.wav')
